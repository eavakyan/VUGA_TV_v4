...
public final class SearchResponse {
    ...
    java.util.List<com.vugaenterprises.androidtv.data.model.Content> content, int totalPages, int currentPage, int totalItems, boolean hasNext, boolean hasPrevious) {
        super();
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.vugaenterprises.androidtv.data.model.Content> getContent() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.vugaenterprises.androidtv.data.model.SearchResponse copy(@org.jetbrains.annotations.NotNull()
    java.util.List<com.vugaenterprises.androidtv.data.model.Content> content, int totalPages, int currentPage, int totalItems, boolean hasNext, boolean hasPrevious) {
        return null;
    }
