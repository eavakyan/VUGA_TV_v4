...
-- ----------------------------
-- Table structure for tv_analytics
-- ----------------------------
DROP TABLE IF EXISTS `tv_analytics`;
CREATE TABLE `tv_analytics` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `channel_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned DEFAULT NULL,
  `profile_id` bigint(20) unsigned DEFAULT NULL,
  `session_id` varchar(100) DEFAULT NULL,
  `action` enum('view','click','watch_start','watch_end','error') NOT NULL,
  `watch_duration_seconds` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `tv_analytics_channel_id_foreign` (`channel_id`),
  KEY `tv_analytics_user_id_index` (`user_id`),
  KEY `tv_analytics_profile_id_index` (`profile_id`),
  KEY `tv_analytics_action_index` (`action`),
  KEY `tv_analytics_created_at_index` (`created_at`),
  CONSTRAINT `tv_analytics_channel_id_foreign` FOREIGN KEY (`channel_id`) REFERENCES `tv_channels` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tv_categories` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tv_categories_slug_unique` (`slug`),
  KEY `tv_categories_parent_id_foreign` (`parent_id`),
  KEY `tv_categories_is_active_index` (`is_active`),
  KEY `tv_categories_order_index_index` (`order_index`),
  CONSTRAINT `tv_categories_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `tv_categories` (`id`) ON DELETE SET NULL
...
-- ----------------------------
-- Table structure for tv_channel_categories
-- ----------------------------
...
CREATE TABLE `tv_channel_categories` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tv_channel_categories_channel_id_category_id_unique` (`channel_id`,`category_id`),
  KEY `tv_channel_categories_category_id_foreign` (`category_id`),
  CONSTRAINT `tv_channel_categories_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `tv_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tv_channel_categories_channel_id_foreign` FOREIGN KEY (`channel_id`) REFERENCES `tv_channels` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tv_channels` (
  ...
  `stream_type` enum('hls','dash','rtmp','youtube','direct') DEFAULT 'hls',
  `logo_url` varchar(500) DEFAULT NULL,
  `thumbnail` varchar(500) DEFAULT NULL,
  `channel_number` int(11) DEFAULT NULL,
  `is_premium` tinyint(1) NOT NULL DEFAULT 0,
  `is_free` tinyint(1) NOT NULL DEFAULT 1,
  `requires_ads` tinyint(1) NOT NULL DEFAULT 0,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  ...
  `epg_url` varchar(500) DEFAULT NULL,
  `drm_license_url` varchar(500) DEFAULT NULL,
  `drm_type` varchar(50) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tv_channels_slug_unique` (`slug`),
  KEY `tv_channels_channel_number_index` (`channel_number`),
  KEY `tv_channels_is_active_index` (`is_active`),
  KEY `tv_channels_is_featured_index` (`is_featured`),
  KEY `tv_channels_order_index_index` (`order_index`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Table structure for tv_schedules
-- ----------------------------
DROP TABLE IF EXISTS `tv_schedules`;
CREATE TABLE `tv_schedules` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tv_schedules_channel_id_foreign` (`channel_id`),
  KEY `tv_schedules_start_time_index` (`start_time`),
  KEY `tv_schedules_end_time_index` (`end_time`),
  KEY `tv_schedules_program_type_index` (`program_type`),
  CONSTRAINT `tv_schedules_channel_id_foreign` FOREIGN KEY (`channel_id`) REFERENCES `tv_channels` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
