          ...
          <form class="forms-sample" id="addUpdateContent">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text"  name="release_year" class="form-control" id="release_year" placeholder="2023" value="@if($data){{$data['release_year']}}@endif">
              </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="verticle_poster">Vertical Poster</label>
  ...
  $("#addUpdateContent").validate({
    ...
    rules: {
      ...
      messages: {
        ...
        verticle_poster: {
          required: "Please Upload Vertical Poster",
        },
        horizontal_poster: {
