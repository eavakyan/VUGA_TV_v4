...
struct FlixyLiveActivityApp: Widget {
    
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: FlixyLiveActivityAttributes.self) { context in
    ...
    //MARK: Expanded Views
    func dynamicIslandExpandedLeadingView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
    ...
    func dynamicIslandExpandedTrailingView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
        VStack {
    ...
    func dynamicIslandExpandedBottomView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
        return VStack {
    ...
    func dynamicIslandExpandedCenterView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
    ...
    //MARK: Compact Views
    func compactLeadingView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
        Image(.logo)
            .resizable()
            .aspectRatio(contentMode: .fit)
    ...
    func compactTrailingView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
        CircularProgressView(progress: context.state.progress)
            .padding(.leading,5)
    }
    
    func minimalView(context: ActivityViewContext<FlixyLiveActivityAttributes>) -> some View {
        CircularProgressView(progress: context.state.progress)
    }
}
...
struct LockScreenView: View {
    var context: ActivityViewContext<FlixyLiveActivityAttributes>
    var body: some View {
        let imageContainer = destination.appendingPathComponent(context.attributes.imageUrl)
